        ...
        for (Item i : listaItems) {
            ...
            if (Objects.equals(i.getIdProducto(), item.getIdProducto())) {
                ...
                if (i.getCantidad() < item.getExistencias()) {
                    //Incrementa en 1 la cantidad de elementos i
...
//Se usa en la página para actualizar la cantidad de productos
    ...
    public void facturar() {
        ...
        for (Item i : listaItems) {
            ...
            Ventas venta = new Ventas(factura.getIdFactura(),
     ...
     @Override
    public Item getByProductoId(Long idProducto) {
        for (Item i : listaItems) {
            if (Objects.equals(i.getIdProducto(), idProducto)) {
                return i;
            }
        }
